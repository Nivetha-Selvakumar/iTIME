...
public class ShiftImpl implements ShiftService {
    ...
    public ResponseWorkHrsDTO calculateWorkingHours(String empId1, String date1) throws CommonException {
            ...
            if(employeeEntity.getShiftId().getShiftType().equals(ShiftType.DAY)){
                dayShiftWorkHoursCalculation(employeeEntity,date,responseWorkHrsDTO);
            }else{
                nightShiftWorkHrsCalculation(employeeEntity,date,responseWorkHrsDTO);
            }
        return  responseWorkHrsDTO;
    }

    private void dayShiftWorkHoursCalculation(EmployeeEntity employeeEntity, LocalDate date, ResponseWorkHrsDTO responseWorkHrsDTO) {
    ...
    private void nightShiftWorkHrsCalculation(EmployeeEntity employeeEntity, LocalDate date, ResponseWorkHrsDTO responseWorkHrsDTO){
